...
import { Users, Building, Map, MapPin } from 'lucide-react';

const Dashboard = () => {
  const { promotores, lojas, rotas, visitas, agencias } = useAppContext();
  ...
  const statCards = [
    ...
    {
      title: 'Agências',
      value: agencias ? agencias.length : 0,
      description: 'Terceirizadas',
      icon: Building,
